 ...
 */
public class NeighborizationAlgorithm2 extends GridAlgorithm {


    public NeighborizationAlgorithm2(Grid grid) {
        super(grid);
    }
    ...
    public void compute() {
        ...
        List<Point> points = NeighborizationAlgorithm2.points(this.grid);

        List<PossibleNeighbours> visibleNeighbours = NeighborizationAlgorithm2.visibleNeighbours(this.grid, points);
        List<PossibleNeighbours> possibleNeighbourss = possibleNeighbours(visibleNeighbours);


        while(!mergeableLines.isEmpty() || !mergeableColumns.isEmpty()){

            System.out.println(current);
            System.out.println(possibleNeighbourss);
            ...
            for(Integer line : mergeableLines){
                ...
                int testNbPossibleNeighbours = NeighborizationAlgorithm2.numberOfNeighbourizable(test, possibleNeighbourss);
    ...
    private static int numberOfNeighbourizable(Grid g, List<PossibleNeighbours> possibleNeighbourss){
        int nb = 0;
    ...
    private static List<PossibleNeighbours> possibleNeighbours(List<PossibleNeighbours> visibleNeighbours){
    ...
    private static List<PossibleNeighbours> visibleNeighbours(Grid g, List<Point> points){
    ...
    private static List<Point> points(Grid g){
